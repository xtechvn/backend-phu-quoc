...
namespace WEB.Adavigo.CMS.Controllers.Funding
{
    ...
    public class DebtBrickController : Controller
    {
        ...
        public IActionResult AddWithContractPay(long contractPayId, long clientId, string billNo, double amount,
        ...
        public IActionResult UndoDebtBrickContractPay(long contractPayId, long clientId, string billNo, double amount,
          double payment)
        {
            var client = _clientRepository.GetClientDetailByClientId(clientId).Result;
            ViewBag.clientName = client?.ClientName;
