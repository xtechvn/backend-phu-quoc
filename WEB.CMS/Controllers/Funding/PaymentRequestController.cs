...
namespace WEB.Adavigo.CMS.Controllers.Funding
{
    ...
    public class PaymentRequestController : Controller
    {
        ...
        public IActionResult AddNew(long serviceId, int serviceType, long supplierId, decimal amount, long orderId, string serviceCode, int clientId)
        {
        ...
        public IActionResult Edit(int paymentRequestId, long serviceId, int serviceType, long supplierId, decimal amount, long orderId, int clientId)
        {
            ViewBag.allCode_PAY_TYPE = _allCodeRepository.GetListByType(AllCodeType.PAY_TYPE);
            ViewBag.allCode_PAYMENT_VOUCHER_TYPE = _allCodeRepository.GetListByType(AllCodeType.PAYMENT_VOUCHER_TYPE);
        ...
        [HttpPost]
        public async Task<IActionResult> GetTourPackageOption(long serviceId, int serviceType = 0)
        {
            try
            {
        ...
        [HttpPost]
        public async Task<IActionResult> GetOtherPackageOption(long serviceId)
        {
            try
            {
        ...
        [HttpPost]
        public async Task<IActionResult> GetHotelPackageOption(long serviceId)
        {
            try
            {
        ...
        [HttpPost]
        public async Task<IActionResult> GetFlyBookingPackagesOptional(long serviceId)
        {
            try
            {
