...
var _set_service_vinwonder_detail = {
    ...
    Initialization: function () {
        ...
        switch ($('#service-vinwonder-detail-data').attr('data-status')) {
            case '1':
            case '2': {
                if (!$('.service-vinwonder-detail-button-ordered').hasClass('active')) {
                    _set_service_vinwonder_detail.ShowNeedToOrderTab()
                }
            } break;
            case '3':
            case '4': {
                if (!$('.service-vinwonder-detail-button-payment').hasClass('active')) {
                    _set_service_vinwonder_detail.ShowPaymentTab()
                }
            } break;
            default: {
                if (!$('.service-vinwonder-detail-button-order').hasClass('active')) {
    ...
    DynamicBindInput: function () {
        $('body').on('click', '.service-vinwonder-detail-change-tab-button', function (event) {
            ...
            switch (element.attr('data-tab-id')) {
                ...
                case '1': {
                    if (!$('.service-vinwonder-detail-button-need-to-order').hasClass('active')) {
                        _set_service_vinwonder_detail.ShowNeedToOrderTab()
                    }
                } break;
                case '2': {
                ...
                case '4': {
                    if (!$('.service-vinwonder-detail-button-servicecode').hasClass('active')) {
                        _set_service_vinwonder_detail.ShowServiceCodeTab()
                    }
                } break;
                case '5': {
                    if (!$('.service-vinwonder-detail-button-refund').hasClass('active')) {
