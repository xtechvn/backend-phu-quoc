...
$(document).ready(function () {
    ...
    var SearchParam = _Contract.GetParam(true)

    if (_Contract.getCookie('contract_filter') != null) {
        let cookie = _Contract.getCookie(cookieName)
        filter = JSON.parse(cookie)
    } else {
        _Contract.setCookie(cookieName, JSON.stringify(filter), 10)
    }
