...
var _customer_manager = {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (x != null) {
                    ...
                    //        id: input.CreatedBy,
                    //        text: textNV,
                    //        html: '<option selected="selected">enhancement</option>'
                    //    }];
                    //    $('#CreatedBy').select2({
                    //        data: data1
                    //    });
    ...
    SearchData: function () {
        ...
        localStorage.setItem("textClient", JSON.stringify(textClient));
        localStorage.setItem("textNT", JSON.stringify(textNT));
        localStorage.setItem("textNV", JSON.stringify(textNV));
        this.SearchClient(objSearch);
