var _order_detail_tour = {
    ...
    CalucateTotalServiceProfit: function () {
        ...
        var profit = (isNaN(parseFloat(profit_text.replaceAll(',', ''))) ? 0 : parseFloat(profit_text.replaceAll(',', '')))
    ...
    Summit: function () {
        ...
        if ((adt_quanity + chd_quanity + inf_quanity) <= 0 || amount <= 0) {
            ...
            base_amount_per_person = amount / (adt_quanity + chd_quanity + inf_quanity)
        }
        ...
        var adt_package = {
            ...
            base_price: base_price_per_person,

            amount: base_amount_per_person * (adt_quanity <= 0 ? 0 : adt_quanity),
            price: base_price_per_person * (adt_quanity <= 0 ? 0 : adt_quanity),
            profit: profit_per_person * (adt_quanity <= 0 ? 0 : adt_quanity),
        ...
        var chd_package = {
            ...
            amount: base_amount_per_person * (chd_quanity <= 0 ? 0 : chd_quanity),
            price: base_price_per_person * (chd_quanity <= 0 ? 0 : chd_quanity),
            profit: profit_per_person * (chd_quanity <= 0 ? 0 : chd_quanity),
        }
        ...
        var inf_package = {
            ...
            amount: base_amount_per_person * (inf_quanity <= 0 ? 0 : inf_quanity),
            price: base_price_per_person * (inf_quanity <= 0 ? 0 : inf_quanity),
            profit: profit_per_person * (inf_quanity <= 0 ? 0 : inf_quanity),
        }
