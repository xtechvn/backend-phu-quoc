var _order_detail_html = {
    ...
    html_new_room_guest: '<tr class="servicemanual-hotel-roomguest-row"> <td class="servicemanual-hotel-roomguest-order">{order}</td> <td><input type="text" class="form-control servicemanual-hotel-roomguest-name" name="servicemanual-hotel-roomguest-name" value="{room_guest_name}"></td> <td><input class="form-control datepicker-input servicemanual-hotel-roomguest-birthday" type="text" name="servicemanual-hotel-roomguest-birthday" value="{room_guest_birthday}"></td> <td> <select class="select2 servicemanual-hotel-roomguest-roomselect-new servicemanual-hotel-roomguest-roomselect" style="width: 100%;"> </select> </td> <td class="text-right"><input type="text" class="form-control servicemanual-hotel-roomguest-note"value="{room_guest_note}"></td> <td><a class="fa fa-plus-circle green" href="javascript:;" onclick="_order_detail_hotel.AddHotelRoomGuest();"></a> <a class="red fa fa-times" href="javascript:;" onclick="_order_detail_hotel.DeleteHotelGuest($(this));"></a>  </td> </tr>',
    ...
    html_service_hotel_newroom:'<tr class="servicemanual-hotel-room-tr" data-room-id="{{new_room_id}}" data-room-type-id="" data-room-type-code=""> <td class="servicemanual-hotel-room-td-order">{{room_order}}</td> <td> <input class="form-control servicemanual-hotel-room-type-name" type="text" name="servicemanual-hotel-room-code" placeholder="Nhập tên hạng phòng" value=""> </td> <td class="servicemanual-hotel-room-td-rates-code"> <div class="d-flex align-center servicemanual-hotel-room-div-code"> <a class="fa fa-trash-o txt_14 mr-2 delete-room-rates-button" style="display: none;" href="javascript:;"></a> <a class="fa fa-plus-circle green mr-1 green add-room-rates-button" href="javascript:;"></a> <input class="form-control servicemanual-hotel-room-rates-code" type="text" data-rate-id="{{new_rate_id}}" name="servicemanual-hotel-room-rates-code" placeholder="Nhập tên gói" value=""> </div> </td> <td class="servicemanual-hotel-room-td-rates-daterange"> <div class="d-flex align-center"> <input class="form-control servicemanual-hotel-room-rates-daterange" type="text" data-rate-id="{{new_rate_id}}" name="servicemanual-hotel-room-rates-daterange" value=""> </div> </td> <td class="servicemanual-hotel-room-td-rates-operator-price"> <div class="d-flex align-center"> <input class="form-control currency servicemanual-hotel-room-rates-operator-price text-right" data-rate-id="{{new_rate_id}}" type="text" name="servicemanual-hotel-room-rates-operator-price" placeholder="Nhập giá nhập vào"> </div> </td> <td class="servicemanual-hotel-room-td-rates-sale-price"> <div class="d-flex align-center"> <input class="form-control currency servicemanual-hotel-room-rates-sale-price text-right" data-rate-id="{{new_rate_id}}" type="text" name="servicemanual-hotel-room-rates-sale-price" placeholder="Nhập giá bán"> </div> </td> <td class="servicemanual-hotel-room-td-rates-nights"> <div class="d-flex align-center"> <input class="form-control currency servicemanual-hotel-room-rates-nights text-right input-disabled-background" data-rate-id="{{new_rate_id}}" type="text" name="servicemanual-hotel-room-rates-nights" disabled value="0"> </div> </td> <td class="servicemanual-hotel-room-td-number-of-rooms"> <div class="d-flex align-center"> <input class="form-control currency servicemanual-hotel-room-number-of-rooms text-right" type="text" name="servicemanual-hotel-room-number-of-rooms" value="1"> </div> </td> <td class="servicemanual-hotel-room-td-rates-total-amount"> <div class="d-flex align-center"> <input class="form-control currency servicemanual-hotel-room-rates-total-amount text-right input-disabled-background" data-rate-id="{{new_rate_id}}" type="text" name="servicemanual-hotel-room-rates-total-amount" disabled value="0"> </div> </td> <td class="servicemanual-hotel-room-td-rates-profit"> <div class="d-flex align-center"> <input class="form-control currency servicemanual-hotel-room-rates-profit text-right input-disabled-background" data-rate-id="{{new_rate_id}}" type="text" name="servicemanual-hotel-room-rates-profit" disabled value="0"> </div> </td> <td class="txt_14"> <a class="fa fa-files-o mr-1 servicemanual-hotel-room-clone-room" href="javascript:;"></a> <a class="fa fa-trash-o servicemanual-hotel-room-delete-room" href="javascript:;"></a> </td> </tr>',
    ...
    html_service_hotel_extrapackage_newextra_package:'<tr class="servicemanual-hotel-extrapackage-tr" data-extrapackage-id="0"> <td class="servicemanual-hotel-extrapackage-td-order">{{order}}</td> <td> <input class="form-control servicemanual-hotel-extrapackage-type-name" type="text" name="servicemanual-hotel-extrapackage-code" placeholder="Nhập nội dung dịch vụ" value=""> </td> <td class="servicemanual-hotel-extrapackage-td-code"> <div class="d-flex align-center  servicemanual-hotel-extrapackage-div-code"> <input class="form-control servicemanual-hotel-extrapackage-code" type="text" name="servicemanual-hotel-extrapackage-code" placeholder="Nhập tên gói" value=""> </div> </td> <td class="servicemanual-hotel-extrapackage-td-daterange"> <div class="d-flex align-center"> <input class="form-control servicemanual-hotel-extrapackage-daterange" type="text" name="servicemanual-hotel-extrapackage-daterange" value=""> </div> </td> <td class="servicemanual-hotel-extrapackage-td-operator-price"> <div class="d-flex align-center"> <input class="form-control currency servicemanual-hotel-extrapackage-operator-price text-right" type="text" name="servicemanual-hotel-extrapackage-operator-price" placeholder="Nhập giá nhập vào"> </div> </td> <td class="servicemanual-hotel-extrapackage-td-sale-price"> <div class="d-flex align-center"> <input class="form-control currency servicemanual-hotel-extrapackage-sale-price text-right" type="text" name="servicemanual-hotel-extrapackage-sale-price" placeholder="Nhập giá bán"> </div> </td> <td class="servicemanual-hotel-extrapackage-td-nights"> <div class="d-flex align-center"> <input class="input-disabled-background form-control currency servicemanual-hotel-extrapackage-nights text-right " type="text" name="servicemanual-hotel-extrapackage-nights" disabled value="0"> </div> </td> <td class="servicemanual-hotel-extrapackage-td-number-of-extrapackages"> <div class="d-flex align-center"> <input class="form-control currency servicemanual-hotel-extrapackage-number-of-extrapackages text-right" type="text" name="servicemanual-hotel-extrapackage-number-of-extrapackages" value="1"> </div> </td> <td class="servicemanual-hotel-extrapackage-td-total-amount"> <div class="d-flex align-center"> <input class="input-disabled-background form-control currency servicemanual-hotel-extrapackage-total-amount text-right" type="text" name="servicemanual-hotel-extrapackage-total-amount" disabled value=""> </div> </td> <td class="servicemanual-hotel-extrapackage-td-profit"> <div class="d-flex align-center"> <input class="input-disabled-background form-control currency servicemanual-hotel-extrapackage-profit text-right" type="text" name="servicemanual-hotel-extrapackage-profit" disabled value=""> </div> </td> <td class="txt_14">  <a class="fa fa-trash-o servicemanual-hotel-extrapackage-delete-extrapackage" href="javascript:;"></a> </td> </tr>',
