...
$(document).ready(function () {
    ...
    _orderDetail.LoadOeederDetail();
});
var _orderDetail = {
    LoadOeederDetail: function () {
        this.LoadClientDetai(input);
        this.LoadPackages(input);
        this.LoadContractPay(input);
        this.LoadBillVAT(input);
        this.LoadListPassenger(input);
        this.LoadFile(input, type);
        this.LoadSingleInformation(input);
        this.LoadPersonInCharge(input);
        this.LoadSystemInformation(input);
    },
