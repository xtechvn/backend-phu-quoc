...
namespace Repositories.IRepositories
{
    public interface IOtherBookingRepository
    {
        ...
        public Task<OtherBooking> GetWaterSportById(long booking_id);
        Task<long> SummitWaterSportBooking(OrderManualWaterSportBookingServiceSummitModel data, int user_summit);
        Task<List<OtherBookingPackages>> GetWaterSportPackagesByBookingId(long booking_id);
        Task<List<OrderWSExcelSuccessModel>> SummitWSOrder(List<OrderWSExcelSQLModel> summit_model);
    }
}
