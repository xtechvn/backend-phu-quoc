...
namespace Repositories.Repositories
{
    public class ContractPayRepository : IContractPayRepository
    {
        ...
        public List<ContractPayViewModel> GetContractPayBySupplierId(long orderId, long serviceId)
        {
            try
            {
                var listServiceOutput = _contractPayDAL.GetContractPayBySupplierId(orderId, serviceId,
