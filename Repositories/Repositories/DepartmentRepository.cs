            ...
            try
            {
                ...
                if (data != null && data.Count > 0)
                {
                    ...
                    foreach (var item in data)
                    {
                        ...
                        ws.Cells["E" + RowIndex].PutValue(item.AmountOpeningBalanceCredit.ToString("N0"));
                        ws.Cells["F" + RowIndex].PutValue(item.AmountOpeningBalanceDebit.ToString("N0"));
                        ws.Cells["G" + RowIndex].PutValue(item.AmountDebit.ToString("N0"));
                        ws.Cells["H" + RowIndex].PutValue(item.AmountCredit.ToString("N0"));
                        ws.Cells["I" + RowIndex].PutValue(item.AmountClosingBalanceDebit.ToString("N0"));
                        ws.Cells["J" + RowIndex].PutValue(item.AmountClosingBalanceCredit.ToString("N0"));
                    }
        ...
        public async Task<string> ExportDepositSupplier(RevenueBySupplierViewModel searchModel, string FilePath, double amount)
        {
            ...
            try
            {
                ...
                if (data != null && data.Count > 0)
                {
                    ...
                    ws.Cells["L" + RowIndex].PutValue(amount.ToString("N0"));
                    foreach (var item in data)
                    {
                        string ttchitiet = string.Empty;
                        ...
                        ws.Cells["I" + RowIndex].PutValue(item.AmountDebit.ToString("N0"));
                        ws.Cells["J" + RowIndex].PutValue(item.AmountCredit.ToString("N0"));
                        ws.Cells["K" + RowIndex].PutValue(item.AmountRemain.ToString("N0"));
                        ws.Cells["L" + RowIndex].PutValue((amount + item.AmountCredit - item.AmountDebit).ToString("N0"));
